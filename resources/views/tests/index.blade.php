...
<div class="container">
	<div class="row">
        <div class="col-md-12">
        	<h4>ALL TESTS
        		<button class="btn btn-primary btn-xs" data-title="New test" data-toggle="modal" data-target="#createTest" >
        			NEW TEST
        		</button>
        	</h4>
        	<div id="app">
		        <div class="table-responsive">
		            <table id="mytable" class="hoverTable table table-bordred table-striped">
			           <thead>
		    			...
		    			<tbody>
		    				<tr v-for="test in tests">
							    ...
							    <td @click="showTest(test.id)">@{{test.created_at | formatDate}}</td>
							    <td>
							    	<p data-placement="top" data-toggle="tooltip" title="Edit">
								    	<button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" @click="openTestEdit(test)">
							    ...
							    <td>
							    	<p data-placement="top" data-toggle="tooltip" title="Delete">
							    		<button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" @click="openTestEdit(test)">
